...
INSERT INTO `tb_order` (
    ...
    `end_date_ord`, `notes_ord`, `id_csh_reg`, `id_usr`
) VALUES (
    'closed', '2024-12-03 08:15:00', 1, 150.00, 'paid',
    '2024-12-03 10:00:00', 'Café da manhã completo.', 1, 1
);
...
INSERT INTO `tb_order` (
    ...
    '2024-12-03 14:00:00', 'Almoço para duas pessoas.', 1, 1
);
...
INSERT INTO `tb_order` (
    ...
    '2024-12-03 16:45:00', 'Lanche da tarde.', 1, 1
);
...
INSERT INTO `tb_order` (
    ...
    '2024-12-04 12:00:00', 'Café da manhã para grupo.', 2, 1
);
...
INSERT INTO `tb_order` (
    ...
    '2024-12-04 15:00:00', 'Almoço executivo.', 2, 1
);
...
INSERT INTO `tb_order` (
    ...
    '2024-12-04 16:00:00', 'Lanche leve.', 2, 1
);
